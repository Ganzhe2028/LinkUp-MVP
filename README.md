...
LinkUp 致力于通过 AI 技术革新传统招聘模式，为企业和人才提供更精准、高效的匹配服务。我们相信，每个人才都应该找到最适合的机会，每个企业都应该遇见最合适的人才。

## ✨ 核心功能

### 🤖 AI 智能匹配

- **语义理解搜索**：支持自然语言查询，如"找个会 AI 的 Python 开发者，最好在北京"
- **多维度评分**：基于技能、经验、地理位置、文化匹配等综合评估
- **智能推荐**：基于 Kimi AI 的深度学习算法，提供个性化人才推荐
...
| `VITE_KIMI_API_KEY`      | Kimi AI API 密钥  | ⚠️   |
| `VITE_KIMI_BASE_URL`     | Kimi API 基础 URL | ⚠️   |

> ⚠️ **安全提醒**：
>
> - 请勿将真实的 API 密钥提交到代码仓库
> - `.env` 文件已被添加到 `.gitignore` 中
> - 未配置 Kimi API 时，系统将使用智能模拟搜索功能
